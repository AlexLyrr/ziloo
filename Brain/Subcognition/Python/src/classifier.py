from src import subcognition as subcog
import numpy as np
...
model_name = subcog.args.classifier
...
def model_predict(img, model):
    ...
    original = image.smart_resize(img, (224, 224))
    ...
    if model_name == 'volo':
        processed_image = preprocess_input(image_batch, mode='torch')
    else:
